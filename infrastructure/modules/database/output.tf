...
output "this_db_instance_availability_zone" {
  ...
  value       = module.database.this_db_instance_availability_zone
}
...
output "this_db_instance_hosted_zone_id" {
  ...
  value       = module.database.this_db_instance_hosted_zone_id
}
...
output "this_db_instance_status" {
  ...
  value       = module.database.this_db_instance_status
}
...
output "this_db_subnet_group_id" {
  ...
  value       = module.database.this_db_subnet_group_id
}

output "this_db_subnet_group_arn" {
  description = "The ARN of the db subnet group"
  value       = module.database.this_db_subnet_group_arn
}

output "this_db_parameter_group_id" {
  description = "The db parameter group id"
  value       = module.database.this_db_parameter_group_id
}

output "this_db_parameter_group_arn" {
  description = "The ARN of the db parameter group"
  value       = module.database.this_db_parameter_group_arn
}